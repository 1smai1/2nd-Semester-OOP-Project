// Project: Gym progression tracker
// Coders:  Ismail Khan Mohmand & Rayan Hussain
// Purpose: To track your gym progress and log it
...
void calculateBMI()
{
    ...
    cout << "2. Calculate in pounds and feet/inches." << endl;
